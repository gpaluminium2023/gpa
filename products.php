...
<!-- Intro Section -->
<div class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('img/6.jpg');">
            ...
            <ul class="list-unstyled ">
              ...
              <li>
                <h5 class="white-text description mb-5 wow fadeIn" data-wow-delay="0.4s">
                  <strong>Patcollins Standard Aluminium</strong> is a trust-worthy aluminium company. We produce
                  <strong>DURABLE and QUALITY</strong> Aluminium products to our clients. Below are some of our
                  products available for production. 
                  <br><strong>N.B.</strong> All thinckness are accurately measured and can be trusted.
                </h5>
              </li>
            </ul>
          </div>
  ...
  <div class="container">
    ...
    <div class="row pt-4">
      ...
      <div class="col-lg-12">
        ...
        <!-- Products Grid -->
        <section class="section pt-4" id="corrugationtypes">

          <h4 class="font-weight-bold mt-4 title-1">

            <strong>CORRUGATION TYPES</strong>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/plongspan.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Long Span</a>

                    </strong>

                  </h5>

                  <span class="badge badge-info mb-2">All Thickness</span>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/psteptiles.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Steptiles</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pmetcoppo.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Metcoppo</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pnormal.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Normal</a>
                  ...
                  <div class="card-footer pb-0">
                    ...
                    <div class="row mb-0">
                      ...
                      <span class="mb-0 pb-0 mt-1 font-weight-bold">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                <!-- Card image -->
                <div class="view overlay">
                  <img src="img/beige.jpg" class="img-fluid" alt="">
                  <a>
                    <div class="mask rgba-white-slight"></div>
                  </a>
                </div>
                ...
                <div class="card-body">
                  <!-- Category & Title -->
                  <h5 class="card-title mb-1">
                    <strong><a href="" class="dark-grey-text">Beige</a></strong>
                  </h5>
                  <!-- Rating -->
                  <ul class="rating">
                  ...
                  <!-- Card footer -->
                  <div class="card-footer pb-0">
                    <span class="badge badge-danger mb-2">Available Gauges</span>
                    <div class="row mb-0">
                      <span class="float-left mr-2"><strong>0.40</strong></span>
                      <span class="float-left mr-2"><strong>0.45</strong></span>
                      <span class="float-left mr-2"><strong>0.50</strong></span>
                      <span class="float-left mr-2"><strong>0.55</strong></span>
                      <span class="float-left mr-2"><strong>0.70</strong></span>
                    </div>
                  </div>
                </div>
                <!-- Card content -->
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                <!-- Card image -->
                <div class="view overlay">
                  <img src="img/black.jpg" class="img-fluid" alt="">
                  <a>
                    <div class="mask rgba-white-slight"></div>
                  </a>
                </div>
                ...
                <div class="card-body">
                  <!-- Category & Title -->
                  <h5 class="card-title mb-1">
                    <strong><a href="" class="dark-grey-text">Black</a></strong>
                  </h5>
                  <!-- Rating -->
                  <ul class="rating">
                    <li><i class="fas fa-star blue-text"></i></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                <!-- Card image -->
                <div class="view overlay">
                  <img src="img/bushgreen.jpg" class="img-fluid" alt="">
                  <a>
                    <div class="mask rgba-white-slight"></div>
                  </a>
                </div>
                ...
                <div class="card-body">
                  <!-- Category & Title -->
                  <h5 class="card-title mb-1">
                    <strong><a href="" class="dark-grey-text">Bush Green</a></strong>
                  </h5>
                  <!-- Rating -->
                  <ul class="rating">
                    <li><i class="fas fa-star blue-text"></i></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                <!-- Card image -->
                <div class="view overlay">
                  <img src="img/navyblue.jpg" class="img-fluid" alt="">
                  <a>
                    <div class="mask rgba-white-slight"></div>
                  </a>
                </div>
                ...
                <div class="card-body">
                  <!-- Category & Title -->
                  <h5 class="card-title mb-1">
                    <strong><a href="" class="dark-grey-text">Copper/Navy Blue</a></strong>
                  </h5>
                  <!-- Rating -->
                  <ul class="rating">
                    <li><i class="fas fa-star blue-text"></i></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                <!-- Card image -->
                <div class="view overlay">
                  <img src="img/deepblue.jpg" class="img-fluid" alt="">
                  <a>
                    <div class="mask rgba-white-slight"></div>
                  </a>
                </div>
                ...
                <div class="card-body">
                  <!-- Category & Title -->
                  <h5 class="card-title mb-1">
                    <strong><a href="" class="dark-grey-text">Deep Blue</a></strong>
                  </h5>
                  <!-- Rating -->
                  <ul class="rating">
                    <li><i class="fas fa-star blue-text"></i></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                <!-- Card image -->
                <div class="view overlay">
                  <img src="img/nutbrown.jpg" class="img-fluid" alt="">
                  <a>
                    <div class="mask rgba-white-slight"></div>
                  </a>
                </div>
                ...
                <div class="card-body">
                  <!-- Category & Title -->
                  <h5 class="card-title mb-1">
                    <strong><a href="" class="dark-grey-text">Nut Brown</a></strong>
                  </h5>
                  <!-- Rating -->
                  <ul class="rating">
                    <li><i class="fas fa-star blue-text"></i></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                <!-- Card image -->
                <div class="view overlay">
                  <img src="img/palegreen.jpg" class="img-fluid" alt="">
                  <a>
                    <div class="mask rgba-white-slight"></div>
                  </a>
                </div>
                ...
                <div class="card-body">
                  <!-- Category & Title -->
                  <h5 class="card-title mb-1">
                    <strong><a href="" class="dark-grey-text">Pale Green</a></strong>
                  </h5>
                  <!-- Rating -->
                  <ul class="rating">
                    <li><i class="fas fa-star blue-text"></i></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                <!-- Card image -->
                <div class="view overlay">
                  <img src="img/tcred.jpg" class="img-fluid" alt="">
                  <a>
                    <div class="mask rgba-white-slight"></div>
                  </a>
                </div>
                ...
                <div class="card-body">
                  <!-- Category & Title -->
                  <h5 class="card-title mb-1">
                    <strong><a href="" class="dark-grey-text">Terra-Cotta Red</a></strong>
                  </h5>
                  <!-- Rating -->
                  <ul class="rating">
                    <li><i class="fas fa-star blue-text"></i></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pbond.png" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Bond</a>

                    </strong>

                  </h5>

                  <span class="badge badge-success mb-2">All Colors</span>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pclassic.png" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Classic</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pmilano.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Milano</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pshingle.png" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Shingle</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pdrivescrew.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Drive Screws</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pseambolt.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Seam Bolts</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pnail.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Nails</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pwasher.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Washers</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pfelt.png" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Felt</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/psilicone.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Silicone</a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card card-ecommerce">
                ...
                <div class="view overlay">
                  ...
                  <img src="img/pflashband.jpg" class="img-fluid"
                    alt="">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title mb-1">
                    ...
                    <strong>
                      ...
                      <a href="" class="dark-grey-text">Flash Band</a>
